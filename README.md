...
This is a repository for Web Application Development 1 (M2I326718-25-B-GLAS).

## Lab 1 - Introduction to HTML

Lab 1 demonstrates basic HTML structure and elements:

- Created first HTML file with proper DOCTYPE and HTML5 structure
